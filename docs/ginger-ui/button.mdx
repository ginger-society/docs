...
The <Button label='Button' type={ButtonType.Primary} /> component is a versatile UI element that can be used for various interactions within your application. Below you will find detailed information about its props and how to use it.
