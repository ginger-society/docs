...
The `AsideWindow` component is a modal-like side panel that slides in from the side of the screen, typically used for additional content or actions without navigating away from the main content.

## Example Usage

```jsx
import React, { useState } from 'react';
import { Text, TextSize } from '@ginger-society/ginger-ui/typography';
import { AsideWindow } from '@ginger-society/ginger-ui';
...
export const AsideExample = () => {
  ...
  return (
    <>
      ...
      <AsideWindow isOpen={isSliderOpen} onClose={() => setIsSliderOpen(false)}>
